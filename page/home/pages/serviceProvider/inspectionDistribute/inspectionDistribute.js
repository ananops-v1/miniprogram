// page/home/pages/serviceProvider/inspectionDistribute/inspectionDistribute.js
import {
  Common
...
Page({
  ...
  clickInspection: function (e) {
    ...
    wx.navigateTo({
      url: "../networkDistribute/networkDistribute?inspectionId=" + e.currentTarget.dataset.id + "&&projectId="+e.currentTarget.dataset.pid,
    })
  },
  //下拉刷新
  lower: function (e) {
